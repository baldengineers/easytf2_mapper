...
try:
    ...
    for f in os.listdir('updated/'):
        try:
            os.remove('updated/'+f)
        except:
            shutil.rmtree('updated/'+f)
    #
    #gets file info
    #
    ...
    saveFile = open('leveltemp/easytf2mapper-master.zip', 'w') 
    saveFile.write(str(respData))
    saveFile.close()
    '''
    with open('leveltemp/easytf2mapper-master.zip', 'wb') as handle:
    ...
    zipupdate = zipfile.ZipFile('leveltemp/easytf2mapper-master.zip', 'r')
    ...
    os.remove('leveltemp/easytf2mapper-master.zip')
